...
function SvgNotFoundComponent(props: any) {
  return (
    <RowComponent gap={30} align="center" direction="column">
      <Svg
        ...
        <Path
          ...
          fill="#5669ff"
        />
        <Circle cx={190.15351} cy={24.95465} r={20} fill="#5669ff" />
        ...
        <Path
          ...
          fill="#5669ff"
        />
        <Circle cx={433.63626} cy={105.17383} r={20} fill="#5669ff" />
        <Circle cx={433.63626} cy={105.17383} r={12.18187} fill="#fff" />
      </Svg>
      <TextComponent
        text={props.text}
        size={props.textSize ?? 12}
        color={colors.gray4}
      />
    </RowComponent>
  );
...
export default SvgNotFoundComponent;
